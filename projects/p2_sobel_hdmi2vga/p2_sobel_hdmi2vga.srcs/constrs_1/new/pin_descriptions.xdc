...
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports RefClk]
create_clock -period 5.000 -name sys_clk_pin -waveform {0.000 2.500} -add [get_ports RefClk]
